/**
  ...
  *
  * @checksum - ee7e815c775ca161cc942fc89ae9eec3c52875d64bfaa7df766171722653de43
  * @variables - radius=rounded-lg,accentColor=cyan,colorTemperature=slate,spacing=1.5,scale=sm,inputShadow=shadow-sm,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-none,tagRadius=rounded-full,swatchRadius=rounded-full
  * @theme - regenesis
  **/
...
const classes = {
  ...
  "rating__ratingItem": {
    ...
    "focus-within:outline-cyan-600": true,
    "w-[1.5em]": true,
    "h-[1.5em]": true
  },
